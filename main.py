...
def load_player_data(cpm):
    ...
    required_keys = {"floats", "localID", "dinero"}
    ...
    console.print(
        f"[bold white]   >> LocalID     : {data.get('ID del jugador', 'UNDEFINED')}[/bold white]"
    )
    console.print(
...
if __name__ == "__main__":
    ...
    while True:
        ...
        acc_email = prompt_valid_value(
            "[bold][?] Account Email[/bold]", "CORREO ELECTRÓNICO", password=False
        )
        acc_password = prompt_valid_value(
            "[bold][?] Account Password[/bold]", "CONTRASEÑA", password=False
        )
        acc_access_key = prompt_valid_value(
            "[bold][?] Access Key[/bold]", "CLAVE DE ACCESO", password=False
        )
        ...
        while True:
            ...
            console.print(
                "[bold red][bold white](36)[/bold white]: Alerón personalizado                 [bold red]10000K[/bold red][/bold red]"
            )
            console.print(
                "[bold red][bold white](37)[/bold white]: Kit de carrocería personalizado                 [bold red]10000K[/bold red][/bold red]"
            )
            console.print(
