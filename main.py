...
╚██████╗██║     ██║ ╚═╝ ██║╚██████╗██║  ██║███████╗██║  ██║   ██║   ███████║
 ╚═════╝╚═╝     ╚═╝     ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝   ╚═╝   ╚══════╝
    ...
    print(
        Colorate.Horizontal(
            Colors.yellow_to_red,
            Center.XCenter("𝗖𝗶𝗲𝗿𝗿𝗲 𝘀𝗲𝘀𝗶𝗼𝗻 𝗲𝗻 𝗰𝗽𝗺 𝗮𝗻𝘁𝗲𝘀 𝗱𝗲 𝘂𝘀𝗮𝗿 𝗹𝗮 𝗵𝗲𝗿𝗿𝗮𝗺𝗶𝗲𝗻𝘁𝗮"),
        )
    )
    ...
    print(
        Colorate.Horizontal(
            Colors.yellow_to_red,
            Center.XCenter("𝗡𝗢 𝗘𝗦𝗧𝗔 𝗣𝗘𝗥𝗠𝗜𝗧𝗢𝗗𝗢 𝗖𝗢𝗠𝗣𝗔𝗥𝗧𝗜𝗥 𝗧𝗨 𝗖𝗟𝗔𝗩𝗘 𝗗𝗘 𝗔𝗖𝗖𝗘𝗦𝗢 𝗦𝗜 𝗟𝗢 𝗛𝗔𝗖𝗘𝗦 𝗦𝗘𝗥𝗔𝗦 𝗕𝗟𝗢𝗤𝗨𝗘𝗔𝗗𝗢"),
        )
    )
...
def load_player_data(cpm):
    ...
    if response.get("ok"):
        ...
        if (
            ...
            print(
                Colorate.Horizontal(
                    Colors.yellow_to_red,
                    Center.XCenter(
                        f"𝖭𝗈𝗆𝖻𝗋𝖾: {name} <> 𝖨𝖣: {local_id} <> 𝖣𝗂𝗇𝖾𝗋𝗈: {money} <> 𝖬𝗈𝗇𝖾𝖽𝖺𝗌: {coin}"
                    ),
                )
            )
        else:
        ...
        print(
            Colorate.Horizontal(
                Colors.yellow_to_red, "⚠️ALERTA: El inicio de sesión parece no estar configurado correctamente !"
            )
        )
...
def load_key_data(cpm):
    ...
    print(
        Colorate.Horizontal(
            Colors.yellow_to_red,
            Center.XCenter(
                "─══════════════════════[ 𝖣𝖤𝖳𝖠𝖫𝖫𝖤𝖲 𝖣𝖤 𝖫𝖠 𝖢𝖫𝖠𝖵𝖤 𝖣𝖤 𝖠𝖢𝖢𝖤𝖲𝖮]══════════════════════─"
            ),
        )
    )
...
def load_client_details():
    ...
    print(
        Colorate.Horizontal(
            Colors.yellow_to_red,
            Center.XCenter(
                f'Pias: {data.get("country")} <> Region: {data.get("regionName")} <> City: {data.get("city")}'
            ),
        )
    )
