        ...
        while True:
                ...
                Colorate.Horizontal(
                    ...
                    Center.XCenter(
                        Box.DoubleCube(
                            ...
                            "➩ (51) Stance Camber               1k     |  ➩ (0) Exit Tool\n\n"
                        )
                    ),
                )
            )
            ...
            if service == 0:  # Exit
                ...
                if status == 0:
                    ...
                    console.print(
                        "[bold yellow] f'INFO: In order to tweak this account with rick[/bold yellow]"
                    )
                    console.print(
                ...
                if cpm.unlock_cls():
                    ...
                    sleep(2)
                    continue
            elif service == 50:  # Unlock All Paid Cars
                console.print(
                    "[!] Note: this function takes a while to complete, please don't cancel.",
                    end=None,
                )
                ...
                if cpm.unlock_paid_cars():
                    ...
                    print(
                        Colorate.Horizontal(Colors.yellow_to_red, "Please try again.")
                    )
                    sleep(2)
                    continue
            else:
